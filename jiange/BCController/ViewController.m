...
-(void)scan{
    ...
    if (self.cbCentralMgr.state == CBCentralManagerStatePoweredOn) {
...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary *)advertisementData RSSI:(NSNumber *)RSSI
{
    ...
    [self addToPeripheralWithPeripheral:peripheral];
}
...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral
{
    ...
    [JoProgressHUD makeToast:@"设备连接成功"];
}
...
- (void)centralManager:(CBCentralManager *)central didFailToConnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error
{
    ...
    [JoProgressHUD makeToast:@"设备连接失败"];
}
...
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error
{
    ...
    [JoProgressHUD makeToast:@"设备取消连接"];
}
...
#pragma mark - Add To PeripheralArray
- (void)addToPeripheralWithPeripheral:(CBPeripheral *)peripheral{
    
    if ([self.peripheralArray containsObject:peripheral]) return;
    ...
    //自动连接
    [self automaticConnectionWithPeripheral:peripheral];
}

#pragma mark - Automatic connection
- (BOOL )automaticConnectionWithPeripheral:(CBPeripheral *)peripheral{
    
    NSUserDefaults * userDefaults = [NSUserDefaults standardUserDefaults];
    
    NSString * peripheralUUID = [userDefaults objectForKey:UD_Peripheral_UUID];
    if (!peripheralUUID) {
        return NO;
    }
    
    if ([peripheralUUID isEqualToString:[peripheral.identifier UUIDString]]) {
