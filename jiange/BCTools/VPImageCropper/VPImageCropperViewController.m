...
- (void)initControlBtn {
    UIView *bgView=[[UIView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, 320, 50)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(220, 0, 100, 50)];
